...
%% create hits matrix
% The hits matrix is a N_cluster1 x N_cluster2 array. In each entry, is the
% count of spikes matching to both i and j clusters
for i=1:N_cluster1
    for j=1:N_cluster2
...
% Spikes from method 1 with no matches in method 2 (first col)  
...
% Spikes from method 2 with no matches in method 1 (first row)
...
% the first row are spikes found in res2 but ARE NOT found in res1