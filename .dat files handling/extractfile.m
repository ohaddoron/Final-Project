...
%
% RC = EXTRACTFILE( SOURCEFILE, NEWFILE, PERIODS, NCHANS, PRECISION )
%
% extract the segment from periods(1,1) to period(1,2) (in samples) of file sourcefile 
...
% 
% this would extract the 10 seconds starting at 0:02:00.000 to a new file;
% assume 20 kHz sampling rate and 56 channels
% 
% see also: PARTITION (extract multiple segments), CONCATFILES (merge back)
