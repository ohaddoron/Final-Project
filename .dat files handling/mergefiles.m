...
%
% call              RC = MERGEFILES( SOURCEFILE1, SOURCEFILE2, NEWFILE, NCHANS, PRECISION, CASTMODE )
%
...
function rc = mergefiles( sourcefile1, sourcefile2, newfile, nchans, precision, castmode )
...
if nsamples1 ~= nsamples2, error( 'file duration/nchans mismatch' ), end
...
if blocksize1 / blocksize2 ~= nchans( 1 ) / nchans( 2 )
